...
var thongbao_detaiController = require('../controllers/thongbao_detai');
...
router.route('/api/thongbao_detai')
    .post(thongbao_detaiController.createThongBaoDeTai)
    .get(thongbao_detaiController.getThongBaoDeTaiList)
